...
:: Configuration
:: Get the name of the folder where this batch file is located
for %%I in ("%~dp0.") do set "FolderName=%%~nxI"

:: Define the merged output filename using the folder name
set "OutputFile=z-Merged - %FolderName%.md"
